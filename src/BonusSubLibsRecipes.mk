...
#    Updated: 2023/06/06 15:01:43 by jgo              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(OBJS)
	...
	$(AR) $(ARFLAGS) $@ $^
	$(Q)$(MAKE) files="$(NAME)" src_dir=`pwd` dst_dir=$(BON_DST_DIR) link_files

clean:
	$(Q)$(MAKE) files="$(NAME)" src_dir=`pwd` dst_dir=$(BON_DST_DIR) unlink_files
